...
plt.figure(5)
plt.subplot(121)
plot_confusion_matrix(running_machine_CM_Acc_F1_Prec_constant[0],classes=['OFF','ON'], title='running_machine confussion matrix\n with constant prior')
plt.subplot(122)
plot_confusion_matrix(running_machine_CM_Acc_F1_Prec_update[0],classes=['OFF','ON'], title='running_machine confussion matrix\n with update prior')
plt.subplots_adjust(left=0.1, bottom=None, right=None, top=None, wspace=0.5, hspace=0.5)
...
plt.figure(6)
plt.subplot(121)
plot_confusion_matrix(washing_machine_CM_Acc_F1_Prec_constant[0],classes=['OFF','ON'], title='washing_machine confussion matrix\n with constant prior')
plt.subplot(122)
plot_confusion_matrix(washing_machine_CM_Acc_F1_Prec_update[0],classes=['OFF','ON'], title='washing_machine confussion matrix\n with update prior')
plt.subplots_adjust(left=0.1, bottom=None, right=None, top=None, wspace=0.5, hspace=0.5)
plt.show()
...
plt.figure(7)
plt.subplot(121)
plot_confusion_matrix(dish_washer_CM_Acc_F1_Prec_constant[0],classes=['OFF','ON'], title='dish_washer confussion matrix\n with constant prior')
plt.subplot(122)
plot_confusion_matrix(dish_washer_CM_Acc_F1_Prec_update[0],classes=['OFF','ON'], title='dish_washer confussion matrix\n with update prior')
plt.subplots_adjust(left=0.1, bottom=None, right=None, top=None, wspace=0.5, hspace=0.5)
